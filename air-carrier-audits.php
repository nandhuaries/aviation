...
<div class="hero px-container bg-blue">
    ...
    <div class="hero-bg" style="background-image: url('our-images/services/avaition-insp/6.jpg');"></div>
</div>
<!-- contents -->
<div class="split px-container bg-body" id="air">
    <div class="split-container">
        <div class="split-image" style="background-image: url('our-images/services/air-carrer/1.jpg');"></div>
