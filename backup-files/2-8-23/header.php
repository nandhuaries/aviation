...
<?php } if($pagename=="helipad-inspections.php") { ?> 
 ...
 <?php } ?>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Barlow:ital,wght@0,400;0,600;1,400;1,600&amp;family=Material+Icons&amp;family=Material+Icons+Outlined&amp;display=swap">
    <!-- <link rel="stylesheet" href="../unpkg.com/animsition%404.0.2/dist/css/animsition.min.css">  outdated link -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animsition/4.0.2/css/animsition.min.css">

    <!-- <link rel="stylesheet" href="../www.unpkg.com/splitting%401.0.6/dist/splitting.css"> old code -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/splitting/1.0.6/splitting.min.css">

    <!-- <link rel="stylesheet" href="../unpkg.com/swiper%406.7.5/swiper-bundle.min.css"> outdated code -->
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/swiper/6.7.5/swiper-bundle.min.css">  from chat gpt -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/9.4.1/swiper-bundle.min.js">
    ...
    <link rel='stylesheet' id='css-0-css' href='wp-content/mmr/f0143356-1684809218.min.css' type='text/css' media='all' />
...
<body class="home page-template page-template-front-page page-template-front-page-php page page-id-7 theme-helideck_theme woocommerce-no-js ">
    ...
    <div class="animsition">
        <div class="site-menu">
            <nav>
                <ul id="menu-responsive-menu" class="site-menu-nav-primary">
                    <!-- <li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236 site-menu-toggle"><a title="Home" href="./"><span class="material-icons">arrow_forward_ios</span>Home</a></li>
                    ...
                    <!-- try arrow -->
                    <li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236 site-menu-toggle">
                        <a href="./">
